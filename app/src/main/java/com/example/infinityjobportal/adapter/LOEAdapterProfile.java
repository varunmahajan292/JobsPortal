...
public class LOEAdapterProfile extends RecyclerView.Adapter<LOEAdapterProfile.ViewHolder> {
    ...
    @NonNull
    @Override
    public LOEAdapterProfile.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_exp_outer_profile, parent, false);
        LOEAdapterProfile.ViewHolder holder = new LOEAdapterProfile.ViewHolder(view);
        return holder;
    }
